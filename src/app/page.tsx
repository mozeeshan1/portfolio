      ...
      >
        <section>
          <div className="h-screen w-full flex flex-col justify-center items-center gap-10 pt-16">
            ...
            <motion.p className="text-md text-center md:text-xl 2xl:text-3xl md:mb-4 md:px-[15%] ">
              Crafting innovative solutions with a focus on machine learning,
              big data, and interactive web experiences.
            </motion.p>
            <Link
        ...
        <section id="about-me" className="my-12 md:px-[10%]">
          ...
          <p className="mx-8 ">
            ...
            also user-centric and market-ready. Beyond my technical
            capabilities, I am passionate about using data to solve complex
            problems and deliver insights that inform strategic decisions.
            <br />
            <br />
            Whether it&apos;s through predictive models for the stock market or
            innovative web applications, my goal is to make technology
            accessible and useful for improving business outcomes and enhancing
            daily life. Dive into my projects to see how I apply these
            principles in various sectors, and let’s explore how we can
            collaborate to transform ideas into impactful digital solutions.
          </p>
        </section>
        {/* Projects Section */}
